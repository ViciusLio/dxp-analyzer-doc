...
CATALOG: Dict[str, Dict[str, str]] = {
    ...
    "metric.chart_visuals": {"en": "Chart visuals", "it": "Grafici"},
    "metric.data_tables": {"en": "Data tables", "it": "Tabelle dati"},
    ...
    "hdr.charts": {"en": "chart_visuals", "it": "grafici"},
    ...
    "sheet.data_tables": {"en": "data_tables", "it": "tabelle_dati"},
